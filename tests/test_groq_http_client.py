...
VALID_PRODUCER_JSON = json.dumps({
    ...
    # narration sits inside the 175-210 spoken-word target band on purpose: the
    # deterministic pre-render gate (2026-09-17 fix) rejects out-of-range scripts
    # into the static fallback, which would mask what these tests measure.
